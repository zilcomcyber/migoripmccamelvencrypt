...
try {
    ...
    if ($current_admin['role'] === 'super_admin') {
        // These are COUNT queries so encryption doesn't affect results
        ...
        // Filter feedback for projects owned by current admin - COUNT queries work with encrypted data
        $stmt = $pdo->prepare("
